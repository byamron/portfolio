...
export const sections: Section[] = [
  ...
  },
  {
    ...
    context: [],
    projects: [
      { id: 'flow', title: 'Designing trust into agentic coding', projectId: 'flow', href: '/project/flow', isLink: true, company: 'Personal project', year: '2026', caseStudySlug: 'flow', status: 'In progress', previewDescription: 'A Claude Code plugin for shipping production software you can trust — agent-run, with the human at the gates that matter.', summary: 'I build a lot with AI; Flow is where I make my coding loops run more autonomously without dropping quality. Two human gates, layered design and engineering review, and a feedback loop that sharpens over time — every run documented on the PR.' },
      { id: 'health-tracker', title: 'A health tracker that leads with insight, not dashboards', projectId: 'health-tracker', href: '/project/health-tracker', isLink: true, company: 'Personal project', year: '2026', caseStudySlug: 'health-tracker', status: 'In progress', previewDescription: 'A comprehensive health tracker with a calmer relationship to your attention — it does the interpreting and shows you what’s worth noticing.', summary: 'Most health apps hand you a dashboard and leave the interpreting to you. I’m building one that’s just as comprehensive but far more considerate about your attention — it does the interpreting, surfaces what’s worth noticing, and never alarms. High signal, low effort. On-device and private.' },
