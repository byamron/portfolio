...
export const sections: Section[] = [
  ...
  },
  {
    ...
    context: [],
    projects: [
      { id: 'arcade', title: 'An arcade of interactive demos', projectId: 'arcade', href: '/arcade', isLink: true, company: 'Personal project', year: '2026', previewDescription: 'A coin-op arcade of physics-driven interaction demos — drag a coin into a cabinet to play.' },
