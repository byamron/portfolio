...
export const sections: Section[] = [
  ...
  },
  {
    ...
    projects: [
      ...
      { id: 'detect-manip', title: 'Detecting manipulative language on the web', projectId: 'detect', href: '', isLink: false, company: 'Personal project', year: '2026' },
