...
export const sections: Section[] = [
  ...
  },
  {
    ...
    projects: [
      { id: 'forge', title: 'Optimizing your AI development workflow', projectId: 'forge', href: '', isLink: false, company: 'Personal project', year: '2026', status: 'In progress', previewDescription: '[IN PROGRESS]\nClaude Code has a deep configuration surface\u2009\u2014\u2009skills, rules, hooks, agents, memory\u2009\u2014\u2009but managing it well requires investment many people don\u2019t have time for. I\u2019m building a Claude Code plugin that analyzes your codebase and how you work, then suggests optimizations to your context and setup in real time\u2009\u2014\u2009so you get the most out of your AI workflow without managing the infrastructure yourself.' },
