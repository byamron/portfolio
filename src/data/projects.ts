...
export const sections: Section[] = [
  ...
  },
  {
    ...
    context: [],
    projects: [
      { id: 'flow', title: 'Designing trust into agentic coding', projectId: 'flow', href: '/project/flow', isLink: true, company: 'Personal project', year: '2026', caseStudySlug: 'flow', status: 'In progress', previewDescription: 'A Claude Code plugin for shipping production software you can trust — agent-run, with the human at the gates that matter.', summary: 'AI coding let me build things I couldn’t before. Flow is the Claude Code plugin that turns my intent into output I can trust — two human gates, automated design and engineering review, and a visual walkthrough on every PR.' },
      { id: 'health-tracker', title: 'A health app that gets out of your way', projectId: 'health-tracker', href: '/project/health-tracker', isLink: true, company: 'Personal project', year: '2026', caseStudySlug: 'health-tracker', status: 'In progress', previewDescription: 'A privacy-first health app that surfaces what matters, says it plainly, and gets out of your way.', summary: 'Most health apps show too much. This one surfaces a few metrics with honest interpretation, then gets out of the way — privacy-first, entirely on-device. Conceived in a Claude chat, iterated in HTML, built with Flow.' },
      { id: 'forge', title: 'Optimizing my AI development workflow', projectId: 'forge', href: '/project/optimizing-my-workflow', isLink: true, company: 'Personal project', year: '2026', caseStudySlug: 'optimizing-my-workflow', videoPreview: '/images/preview-forge.mp4', status: 'In progress', summary: 'Claude Code\u2019s configuration infrastructure is powerful, but keeping it optimized is real work. I built a Claude Code plugin that watches your sessions, detects patterns, and proposes improvements\u2009\u2014\u2009rules, hooks, skills, scoped artifacts. Everything is a proposal you review. Nothing auto-applies.' },
      { id: 'language-app', title: 'Voice-first language practice with personalized feedback', projectId: 'language-app', href: '/project/language-app', isLink: true, company: 'Personal project', year: '2026', caseStudySlug: 'language-app', videoPreview: '/images/preview-language-app.mp4', status: 'In progress', summary: 'Most language apps teach you to tap and swipe\u2009\u2014\u2009not speak. I\u2019m building a native iOS app with two modes: a five-minute voice conversation with a Gemini-powered partner, and a feed of corrections built from things you actually said. No lessons, no streaks, no XP.' },
      { id: 'detect-manip', title: 'Detecting manipulative language on the web', projectId: 'detect', href: '/project/manipulation-identifier', isLink: true, company: 'Personal project', year: '2026', caseStudySlug: 'manipulation-identifier', videoPreview: '/images/preview-detect-manip.mp4', status: 'In progress', summary: 'I\u2019m building a Chrome extension that uses LLMs to identify and explain manipulative language on the web\u2009\u2014\u2009fear-mongering, false dichotomies, ad hominem attacks, twelve others. Educate, don\u2019t censor. The hard part isn\u2019t detection; it\u2019s keeping false positives low enough that the highlights stay trusted.' },
