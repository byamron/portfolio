...
export const sections: Section[] = [
  ...
  },
  {
    ...
    projects: [
      ...
      { id: 'language-app', title: 'Voice-first language practice with personalized feedback', projectId: 'language-app', href: '/project/language-app', isLink: true, company: 'Personal project', year: '2026', caseStudySlug: 'language-app', status: 'In progress', summary: 'Most language apps teach you to tap and swipe\u2009\u2014\u2009not speak. I\u2019m building a native iOS app with real-time voice conversations and an async feed of corrections generated from things you actually said.' },
      { id: 'detect-manip', title: 'Detecting manipulative language on the web', projectId: 'detect', href: '/project/manipulation-identifier', isLink: true, company: 'Personal project', year: '2026', caseStudySlug: 'manipulation-identifier', status: 'In progress', summary: 'Most misinformation tools focus on false claims. I\u2019m building a Chrome extension that identifies and explains manipulative rhetoric\u2009\u2014\u2009the subtle tactics that are hardest to recognize.' },
