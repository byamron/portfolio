...
export const mochiProgressTracker: CaseStudy = {
  ...
  narrative: [
    'Patients reported their weight to their provider every month, yet most still saw nothing in their own progress tracker. Mochi tracked weight in two places that didn\u2019t talk to each other\u2009\u2014\u2009one for patients, one for providers. I killed the split. Provider-recorded weights now appear automatically in the patient\u2019s tracker. Patients get a filled-out history without logging anything; providers get the data they need to approve refills. What started as a low-priority feature is now infrastructure the clinical team can\u2019t operate without.',
    'The surface layer mattered too. The progress tracker had 30% lifetime usage\u2009\u2014\u2009mostly because it didn\u2019t work on mobile. I redesigned it with mobile support and cleaner data visualization. 53% increase in weekly active users within two weeks.',
  ],
  sections: [
    {
      id: 'tracker-problem',
...
export const cipElectionMisinformation: CaseStudy = {
  ...
  timeline: '2022\u20132025',
  narrative: [
    'Election rumors aren\u2019t about getting the facts wrong\u2009\u2014\u2009they\u2019re about framing. Working with Dr. Kate Starbird\u2019s research group at UW\u2019s Center for an Informed Public, I analyzed how election misinformation spreads on Twitter\u2009\u2014\u2009not through fabrication, but through framing. A photo, a statistic, a real policy change becomes misleading depending on the narrative wrapped around it. I helped build a framework mapping how identical evidence gets assembled into opposing claims. Two papers presented at CSCW 2025.',
...
export const acornEatLocalVt: CaseStudy = {
  ...
  narrative: [
    ...
    'I sat in every engineering meeting\u2009\u2014\u2009not because I understood everything, but because I wanted to be a real partner. That instinct stuck. I still treat engineering collaboration as the starting point, not the handoff.',
  ],
}
...
export const trioTodoList: CaseStudy = {
  ...
  narrative: [
    ...
    'I built a todo app that maintains itself through light infrastructure on input. Every task you add gets ranked through pairwise comparisons\u2009\u2014\u2009you just pick between two tasks at a time, and the system keeps a running priority order. No dragging, no labels, no maintenance. When you\u2019re ready to work, you pull tasks into today\u2009\u2014\u2009but you can only hold three at a time. Finish one, pull the next. The constraint keeps you moving instead of staring.',
  ],
  sections: [
    {
      id: 'trio-product',
...
export const manipulationIdentifier: CaseStudy = {
  ...
  narrative: [
    ...
    'With many tactics and an LLM doing the labeling, false positives are a bigger problem than missed tactics. I built an evaluation harness around a hand-curated test corpus so prompt changes can be measured rather than guessed at. BYOK Gemini key, no telemetry, nothing collected.',
  ],
}
...
export const patientStateFactory: CaseStudy = {
  ...
  timeline: '2026',
  narrative: [
    'Testing anything on Mochi’s platform meant first getting a patient account into the exact state you needed — mid-refill with a failed payment, mid-onboarding, a denied request. That took changing the account by hand in the database, dozens of interdependent fields at a time. The friction wasn’t just slow; it decided who could participate — engineers often skipped it, non-technical teammates couldn’t do it at all, and testing defaulted to production, where, in a healthcare product, real patient data can slip.',
